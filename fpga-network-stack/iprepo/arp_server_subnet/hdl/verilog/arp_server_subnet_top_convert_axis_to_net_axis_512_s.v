...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_done_reg == 1'b1) | ((tmp_reg_93 == 1'd1) & (arpDataIn_internal_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_36_p6 == 1'd1) & (s_axis_TVALID_int_regslice == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_done_reg == 1'b1) | ((tmp_reg_93 == 1'd1) & (arpDataIn_internal_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_36_p6 == 1'd1) & (s_axis_TVALID_int_regslice == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_done_reg == 1'b1) | ((tmp_reg_93 == 1'd1) & (arpDataIn_internal_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_36_p6 == 1'd1) & (s_axis_TVALID_int_regslice == 1'b0)))));
end

always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_36_p6 == 1'd1) & (s_axis_TVALID_int_regslice == 1'b0)));
end

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((tmp_reg_93 == 1'd1) & (arpDataIn_internal_full_n == 1'b0));
end
...
assign arpDataIn_internal_din = tmp_16_i_fu_81_p4;

assign s_axis_TREADY = regslice_both_s_axis_V_data_V_U_ack_in;

assign tmp_16_i_fu_81_p4 = {{{tmp_last_V_reg_107}, {tmp_keep_V_reg_102}}, {tmp_data_V_reg_97}};

assign tmp_nbreadreq_fu_36_p6 = s_axis_TVALID_int_regslice;
