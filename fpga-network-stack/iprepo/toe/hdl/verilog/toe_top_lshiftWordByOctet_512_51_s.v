...
wire   [31:0] tmp_518_i_fu_176_p4;
wire   [255:0] grp_fu_110_p4;
wire   [31:0] grp_fu_119_p4;
wire   [511:0] p_Result_s_fu_226_p3;
wire   [511:0] p_Result_198_fu_240_p3;
wire   [63:0] p_Result_197_fu_233_p3;
wire   [63:0] p_Result_199_fu_247_p3;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_515_i_reg_313 == 1'd1) & (ls_writeRemainder_1_load_reg_299 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_515_i_nbreadreq_fu_76_p3 == 1'd1) & (ls_writeRemainder_1 == 1'd0) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_515_i_nbreadreq_fu_76_p3 == 1'd1) & (ls_writeRemainder_1 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        sendWord_last_V_reg_332 <= sendWord_last_V_fu_186_p2;
        tmp_517_i_reg_326 <= {{txEng_tcpPkgBuffer0_dout[543:512]}};
...
always @ (*) begin
    ap_condition_127 = ((tmp_515_i_nbreadreq_fu_76_p3 == 1'd1) & (ls_writeRemainder_1 == 1'd0) & (currWord_last_V_fu_154_p3 == 1'd1));
end

always @ (*) begin
    ap_condition_131 = ((tmp_515_i_nbreadreq_fu_76_p3 == 1'd1) & (ls_writeRemainder_1 == 1'd0) & (currWord_last_V_fu_154_p3 == 1'd0));
end
...
always @ (*) begin
    ap_predicate_op18_read_state1 = ((tmp_515_i_nbreadreq_fu_76_p3 == 1'd1) & (ls_writeRemainder_1 == 1'd0));
end

always @ (*) begin
    ap_predicate_op44_write_state2 = ((tmp_515_i_reg_313 == 1'd1) & (ls_writeRemainder_1_load_reg_299 == 1'd0));
end
...
assign grp_fu_119_p4 = {{p_Val2_44_reg_308[63:32]}};
...
assign p_Result_197_fu_233_p3 = {{tmp_517_i_reg_326}, {32'd4294967295}};

assign p_Result_198_fu_240_p3 = {{trunc_ln674_reg_320}, {grp_fu_110_p4}};

assign p_Result_199_fu_247_p3 = {{tmp_517_i_reg_326}, {grp_fu_119_p4}};

assign p_Result_s_fu_226_p3 = {{trunc_ln674_reg_320}, {256'd0}};

assign select_ln600_fu_262_p3 = ((ls_firstWord_1[0:0] == 1'b1) ? p_Result_197_fu_233_p3 : p_Result_199_fu_247_p3);

assign sendWord_data_V_13_fu_254_p3 = ((ls_firstWord_1[0:0] == 1'b1) ? p_Result_s_fu_226_p3 : p_Result_198_fu_240_p3);

assign sendWord_last_V_fu_186_p2 = ((tmp_518_i_fu_176_p4 == 32'd0) ? 1'b1 : 1'b0);

assign tmp_515_i_nbreadreq_fu_76_p3 = txEng_tcpPkgBuffer0_empty_n;

assign tmp_518_i_fu_176_p4 = {{txEng_tcpPkgBuffer0_dout[575:544]}};
