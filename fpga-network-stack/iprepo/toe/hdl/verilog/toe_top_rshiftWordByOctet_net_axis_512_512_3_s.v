...
reg   [0:0] fsmState_1_load_reg_256;
reg   [0:0] tmp_i_reg_270;
reg   [0:0] rs_firstWord_1_load_reg_277;
...
reg   [511:0] p_Val2_s_reg_260;
reg   [63:0] p_Val2_15_reg_265;
wire   [0:0] rs_firstWord_1_load_load_fu_166_p1;
wire   [255:0] trunc_ln674_fu_170_p1;
reg   [255:0] trunc_ln674_reg_281;
reg   [31:0] tmp_417_i_reg_286;
wire   [0:0] sendWord_last_V_fu_194_p2;
reg   [0:0] sendWord_last_V_reg_291;
...
wire   [576:0] p_0_fu_231_p6;
reg    ap_block_pp0_stage0_01001;
wire   [576:0] p_03_fu_243_p5;
wire   [31:0] tmp_418_i_fu_184_p4;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_i_nbreadreq_fu_72_p3 == 1'd1) & (fsmState_1 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (rs_firstWord_1_load_load_fu_166_p1 == 1'd0))) begin
        ...
        tmp_417_i_reg_286 <= {{rxEng_dataBuffer3a_dout[543:512]}};
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp0_stage0) & (fsmState_1_load_reg_256 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'b0 == ap_block_pp0_stage0) & (ap_predicate_op45_write_state2 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    if ((1'b1 == ap_condition_166)) begin
        if ((fsmState_1_load_reg_256 == 1'd1)) begin
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp0_stage0_11001) & (fsmState_1_load_reg_256 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'b0 == ap_block_pp0_stage0_11001) & (ap_predicate_op45_write_state2 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (((fsmState_1_load_reg_256 == 1'd1) & (rxEng_dataBuffer3b_full_n == 1'b0)) | ((ap_predicate_op45_write_state2 == 1'b1) & (rxEng_dataBuffer3b_full_n == 1'b0)))) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((ap_predicate_op18_read_state1 == 1'b1) & (rxEng_dataBuffer3a_empty_n == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (((fsmState_1_load_reg_256 == 1'd1) & (rxEng_dataBuffer3b_full_n == 1'b0)) | ((ap_predicate_op45_write_state2 == 1'b1) & (rxEng_dataBuffer3b_full_n == 1'b0)))) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((ap_predicate_op18_read_state1 == 1'b1) & (rxEng_dataBuffer3a_empty_n == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (((fsmState_1_load_reg_256 == 1'd1) & (rxEng_dataBuffer3b_full_n == 1'b0)) | ((ap_predicate_op45_write_state2 == 1'b1) & (rxEng_dataBuffer3b_full_n == 1'b0)))) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((ap_predicate_op18_read_state1 == 1'b1) & (rxEng_dataBuffer3a_empty_n == 1'b0)))));
end
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (((fsmState_1_load_reg_256 == 1'd1) & (rxEng_dataBuffer3b_full_n == 1'b0)) | ((ap_predicate_op45_write_state2 == 1'b1) & (rxEng_dataBuffer3b_full_n == 1'b0)));
end
...
always @ (*) begin
    ap_predicate_op45_write_state2 = ((rs_firstWord_1_load_reg_277 == 1'd0) & (tmp_i_reg_270 == 1'd1) & (fsmState_1_load_reg_256 == 1'd0));
end

assign currWord_data_V_fu_144_p1 = rxEng_dataBuffer3a_dout[511:0];

assign currWord_last_V_fu_158_p3 = rxEng_dataBuffer3a_dout[32'd576];

assign fsmState_1_load_load_fu_132_p1 = fsmState_1;

assign grp_fu_114_p4 = {{p_Val2_s_reg_260[511:256]}};

assign grp_fu_123_p4 = {{p_Val2_15_reg_265[63:32]}};

assign p_03_fu_243_p5 = {{{{{{33'd4294967296}, {grp_fu_123_p4}}}, {256'd0}}}, {grp_fu_114_p4}};

assign p_0_fu_231_p6 = {{{{{sendWord_last_V_reg_291}, {tmp_417_i_reg_286}}, {grp_fu_123_p4}}, {trunc_ln674_reg_281}}, {grp_fu_114_p4}};

assign rs_firstWord_1_load_load_fu_166_p1 = rs_firstWord_1;

assign sendWord_last_V_fu_194_p2 = ((tmp_418_i_fu_184_p4 == 32'd0) ? 1'b1 : 1'b0);

assign tmp_418_i_fu_184_p4 = {{rxEng_dataBuffer3a_dout[575:544]}};
