...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_5_i_nbreadreq_fu_84_p3 == 1'd1) & (ls_writeRemainder == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_7_i7_reg_344 <= {{s_axis_tx_data_internal_dout[567:512]}};
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (((ls_writeRemainder_load_reg_327 == 1'd1) & (tx_shift2udpFifo_full_n == 1'b0)) | ((ap_predicate_op47_write_state2 == 1'b1) & (tx_shift2udpFifo_full_n == 1'b0)))) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((ap_predicate_op18_read_state1 == 1'b1) & (s_axis_tx_data_internal_empty_n == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (((ls_writeRemainder_load_reg_327 == 1'd1) & (tx_shift2udpFifo_full_n == 1'b0)) | ((ap_predicate_op47_write_state2 == 1'b1) & (tx_shift2udpFifo_full_n == 1'b0)))) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((ap_predicate_op18_read_state1 == 1'b1) & (s_axis_tx_data_internal_empty_n == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (((ls_writeRemainder_load_reg_327 == 1'd1) & (tx_shift2udpFifo_full_n == 1'b0)) | ((ap_predicate_op47_write_state2 == 1'b1) & (tx_shift2udpFifo_full_n == 1'b0)))) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((ap_predicate_op18_read_state1 == 1'b1) & (s_axis_tx_data_internal_empty_n == 1'b0)))));
end
...
assign or_ln174_6_i_fu_288_p5 = {{{{{{1'd0}, {sendWord_last_V_reg_350}}}, {select_ln1127_fu_280_p3}}}, {sendWord_data_V_2_fu_272_p3}};
...
assign tmp_5_i_nbreadreq_fu_84_p3 = s_axis_tx_data_internal_empty_n;

assign tmp_8_i8_fu_194_p4 = {{s_axis_tx_data_internal_dout[575:568]}};
