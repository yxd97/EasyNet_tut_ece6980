...
architecture behav of udp_top is 
    ...
    "udp_top_udp_top,hls_ip_2022_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcu280-fsvh2892-2L-e,HLS_INPUT_CLOCK=3.200000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=2.686000,HLS_SYN_LAT=7,HLS_SYN_TPT=1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=21108,HLS_SYN_LUT=8332,HLS_VERSION=2022_1}";
    ...
    signal reg_listen_port_c_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal reg_listen_port_c_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    ...
    port (
        ...
        reg_listen_port_c_num_data_valid : IN STD_LOGIC_VECTOR (2 downto 0);
        reg_listen_port_c_fifo_cap : IN STD_LOGIC_VECTOR (2 downto 0);
    ...
    component udp_top_convert_net_axis_to_axis_512_2 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    ...
    port map (
        ...
        reg_listen_port_c_num_data_valid => reg_listen_port_c_num_data_valid,
        reg_listen_port_c_fifo_cap => reg_listen_port_c_fifo_cap,
    ...
    convert_net_axis_to_axis_512_2_U0 : component udp_top_convert_net_axis_to_axis_512_2
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    port map (
        ...
        regListenPort_num_data_valid => reg_listen_port_c_num_data_valid,
        regListenPort_fifo_cap => reg_listen_port_c_fifo_cap,
    ...
    port map (
        ...
        if_num_data_valid => reg_listen_port_c_num_data_valid,
        if_fifo_cap => reg_listen_port_c_fifo_cap,
