...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_5_i_nbreadreq_fu_84_p3 = ap_const_lv1_1) and (ls_writeRemainder = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                tmp_7_i7_reg_344 <= s_axis_tx_data_internal_dout(567 downto 512);
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, s_axis_tx_data_internal_empty_n, ap_predicate_op18_read_state1, ap_done_reg, tx_shift2udpFifo_full_n, ls_writeRemainder_load_reg_327, ap_predicate_op47_write_state2)
    begin
                ap_block_pp0_stage0_01001 <= ((ap_done_reg = ap_const_logic_1) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (((ls_writeRemainder_load_reg_327 = ap_const_lv1_1) and (tx_shift2udpFifo_full_n = ap_const_logic_0)) or ((ap_predicate_op47_write_state2 = ap_const_boolean_1) and (tx_shift2udpFifo_full_n = ap_const_logic_0)))) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((ap_predicate_op18_read_state1 = ap_const_boolean_1) and (s_axis_tx_data_internal_empty_n = ap_const_logic_0)))));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, s_axis_tx_data_internal_empty_n, ap_predicate_op18_read_state1, ap_done_reg, tx_shift2udpFifo_full_n, ls_writeRemainder_load_reg_327, ap_predicate_op47_write_state2)
    begin
                ap_block_pp0_stage0_11001 <= ((ap_done_reg = ap_const_logic_1) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (((ls_writeRemainder_load_reg_327 = ap_const_lv1_1) and (tx_shift2udpFifo_full_n = ap_const_logic_0)) or ((ap_predicate_op47_write_state2 = ap_const_boolean_1) and (tx_shift2udpFifo_full_n = ap_const_logic_0)))) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((ap_predicate_op18_read_state1 = ap_const_boolean_1) and (s_axis_tx_data_internal_empty_n = ap_const_logic_0)))));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, s_axis_tx_data_internal_empty_n, ap_predicate_op18_read_state1, ap_done_reg, tx_shift2udpFifo_full_n, ls_writeRemainder_load_reg_327, ap_predicate_op47_write_state2)
    begin
                ap_block_pp0_stage0_subdone <= ((ap_done_reg = ap_const_logic_1) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (((ls_writeRemainder_load_reg_327 = ap_const_lv1_1) and (tx_shift2udpFifo_full_n = ap_const_logic_0)) or ((ap_predicate_op47_write_state2 = ap_const_boolean_1) and (tx_shift2udpFifo_full_n = ap_const_logic_0)))) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((ap_predicate_op18_read_state1 = ap_const_boolean_1) and (s_axis_tx_data_internal_empty_n = ap_const_logic_0)))));
    end process;
    ...
    or_ln174_6_i_fu_288_p5 <= (((ap_const_lv1_0 & sendWord_last_V_reg_350) & select_ln1127_fu_280_p3) & sendWord_data_V_2_fu_272_p3);
    ...
    tmp_5_i_nbreadreq_fu_84_p3 <= (0=>(s_axis_tx_data_internal_empty_n), others=>'-');
    tmp_8_i8_fu_194_p4 <= s_axis_tx_data_internal_dout(575 downto 568);
    ...
    zext_ln174_cast_fu_310_p5 <= (((ap_const_lv57_100000000000000 & reg_140) & ap_const_lv448_lc_2) & reg_136);
