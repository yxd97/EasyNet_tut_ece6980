...
wire   [511:0] tmp_data_V_fu_77_p1;
reg   [511:0] tmp_data_V_reg_103;
reg   [63:0] tmp_keep_V_reg_108;
reg   [0:0] tmp_last_V_reg_113;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_i_nbreadreq_fu_46_p3 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_keep_V_reg_108 <= {{txDataBuffer_dout[575:512]}};
        tmp_last_V_reg_113 <= txDataBuffer_dout[1024'd576];
    end
end
...
always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((ap_done_reg == 1'b1) | ((tmp_i_nbreadreq_fu_46_p3 == 1'd1) & (txDataBuffer_empty_n == 1'b0)));
end
...
assign tmp_data_V_fu_77_p1 = txDataBuffer_dout[511:0];

assign tmp_i_nbreadreq_fu_46_p3 = txDataBuffer_empty_n;
