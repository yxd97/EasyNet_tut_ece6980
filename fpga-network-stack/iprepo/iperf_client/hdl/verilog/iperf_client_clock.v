...
module iperf_client_clock (
        ...
        ap_ready,
        timeInCycles_dout,
        timeInCycles_num_data_valid,
        timeInCycles_fifo_cap,
...
input  [2:0] timeInCycles_num_data_valid;
input  [2:0] timeInCycles_fifo_cap;
...
wire   [0:0] sw_state_load_load_fu_78_p1;
wire   [0:0] tmp_i_nbreadreq_fu_56_p3;
reg    ap_predicate_op20_read_state2;
reg    ap_block_state2_pp0_stage0_iter1;
reg   [0:0] sw_state_load_reg_130;
reg   [0:0] icmp_ln1065_reg_137;
...
reg   [63:0] timeInCycles_read_reg_125;
reg    ap_block_pp0_stage0_11001;
wire   [0:0] icmp_ln1065_fu_114_p2;
wire   [47:0] add_ln886_fu_98_p2;
reg    ap_block_pp0_stage0_01001;
wire   [63:0] zext_ln1065_fu_110_p1;
reg   [0:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_120)) begin
        if (((sw_state_load_load_fu_78_p1 == 1'd1) & (icmp_ln1065_fu_114_p2 == 1'd1))) begin
            sw_state <= 1'd0;
        end else if (((tmp_i_nbreadreq_fu_56_p3 == 1'd1) & (sw_state == 1'd0))) begin
            sw_state <= 1'd1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_120)) begin
        if ((sw_state_load_load_fu_78_p1 == 1'd1)) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (sw_state_load_load_fu_78_p1 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln886_fu_98_p2 = (time_V + 48'd1);
...
always @ (*) begin
    ap_condition_120 = ((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0));
end
...
always @ (*) begin
    ap_predicate_op20_read_state2 = ((tmp_i_nbreadreq_fu_56_p3 == 1'd1) & (sw_state == 1'd0));
end

always @ (*) begin
    ap_predicate_op32_write_state3 = ((icmp_ln1065_reg_137 == 1'd1) & (sw_state_load_reg_130 == 1'd1));
end

assign icmp_ln1065_fu_114_p2 = ((zext_ln1065_fu_110_p1 == timeInCycles_read_reg_125) ? 1'b1 : 1'b0);

assign stopSignalFifo_din = 1'd1;

assign sw_state_load_load_fu_78_p1 = sw_state;

assign tmp_i_nbreadreq_fu_56_p3 = startSignalFifo_empty_n;

assign zext_ln1065_fu_110_p1 = add_ln886_fu_98_p2;
