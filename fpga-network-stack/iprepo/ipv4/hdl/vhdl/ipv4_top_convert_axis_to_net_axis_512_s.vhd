...
attribute shreg_extract : string;
    ...
    signal tmp_25_i_fu_81_p4 : STD_LOGIC_VECTOR (576 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_nbreadreq_fu_36_p6 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                tmp_data_V_reg_97 <= s_axis_rx_data_TDATA_int_regslice;
                tmp_keep_V_reg_102 <= s_axis_rx_data_TKEEP_int_regslice;
                tmp_last_V_reg_107 <= s_axis_rx_data_TLAST_int_regslice;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, tmp_nbreadreq_fu_36_p6, ap_done_reg, s_axis_rx_data_internal_full_n, tmp_reg_93, s_axis_rx_data_TVALID_int_regslice)
    begin
                ap_block_pp0_stage0_01001 <= ((ap_done_reg = ap_const_logic_1) or ((tmp_reg_93 = ap_const_lv1_1) and (s_axis_rx_data_internal_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((tmp_nbreadreq_fu_36_p6 = ap_const_lv1_1) and (s_axis_rx_data_TVALID_int_regslice = ap_const_logic_0)))));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, tmp_nbreadreq_fu_36_p6, ap_done_reg, s_axis_rx_data_internal_full_n, tmp_reg_93, s_axis_rx_data_TVALID_int_regslice)
    begin
                ap_block_pp0_stage0_11001 <= ((ap_done_reg = ap_const_logic_1) or ((tmp_reg_93 = ap_const_lv1_1) and (s_axis_rx_data_internal_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((tmp_nbreadreq_fu_36_p6 = ap_const_lv1_1) and (s_axis_rx_data_TVALID_int_regslice = ap_const_logic_0)))));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, tmp_nbreadreq_fu_36_p6, ap_done_reg, s_axis_rx_data_internal_full_n, tmp_reg_93, s_axis_rx_data_TVALID_int_regslice)
    begin
                ap_block_pp0_stage0_subdone <= ((ap_done_reg = ap_const_logic_1) or ((tmp_reg_93 = ap_const_lv1_1) and (s_axis_rx_data_internal_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((tmp_nbreadreq_fu_36_p6 = ap_const_lv1_1) and (s_axis_rx_data_TVALID_int_regslice = ap_const_logic_0)))));
    end process;


    ap_block_state1_pp0_stage0_iter0_assign_proc : process(tmp_nbreadreq_fu_36_p6, ap_done_reg, s_axis_rx_data_TVALID_int_regslice)
    begin
                ap_block_state1_pp0_stage0_iter0 <= ((ap_done_reg = ap_const_logic_1) or ((tmp_nbreadreq_fu_36_p6 = ap_const_lv1_1) and (s_axis_rx_data_TVALID_int_regslice = ap_const_logic_0)));
    end process;


    ap_block_state2_pp0_stage0_iter1_assign_proc : process(s_axis_rx_data_internal_full_n, tmp_reg_93)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((tmp_reg_93 = ap_const_lv1_1) and (s_axis_rx_data_internal_full_n = ap_const_logic_0));
    end process;
    ...
    s_axis_rx_data_TDATA_blk_n_assign_proc : process(ap_start, ap_CS_fsm_pp0_stage0, tmp_nbreadreq_fu_36_p6, ap_done_reg, ap_block_pp0_stage0, s_axis_rx_data_TVALID_int_regslice)
    begin
    ...
    s_axis_rx_data_TREADY_int_regslice_assign_proc : process(ap_start, ap_CS_fsm_pp0_stage0, tmp_nbreadreq_fu_36_p6, ap_block_pp0_stage0_11001)
    begin
    ...
    s_axis_rx_data_internal_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, s_axis_rx_data_internal_full_n, tmp_reg_93, ap_block_pp0_stage0)
    begin
    ...
    s_axis_rx_data_internal_din <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_25_i_fu_81_p4),1024));

    s_axis_rx_data_internal_write_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, tmp_reg_93, ap_block_pp0_stage0_11001)
    begin
    ...
    tmp_25_i_fu_81_p4 <= ((tmp_last_V_reg_107 & tmp_keep_V_reg_102) & tmp_data_V_reg_97);
    tmp_nbreadreq_fu_36_p6 <= (0=>(s_axis_rx_data_TVALID_int_regslice), others=>'-');
end behav;
