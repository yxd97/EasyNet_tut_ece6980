...
attribute shreg_extract : string;
    ...
    signal tmp_3_i_nbreadreq_fu_84_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_3_i_reg_331 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_5_i7_reg_344 : STD_LOGIC_VECTOR (43 downto 0);
    ...
    signal tmp_6_i8_fu_194_p4 : STD_LOGIC_VECTOR (19 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_3_i_reg_331 = ap_const_lv1_1) and (ls_writeRemainder_load_reg_327 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_3_i_nbreadreq_fu_84_p3 = ap_const_lv1_1) and (ls_writeRemainder = ap_const_lv1_0) and (ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_3_i_nbreadreq_fu_84_p3 = ap_const_lv1_1) and (ls_writeRemainder = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                sendWord_last_V_reg_350 <= sendWord_last_V_fu_204_p2;
                tmp_5_i7_reg_344 <= s_axis_tx_data_internal_dout(555 downto 512);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ls_writeRemainder = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                tmp_3_i_reg_331 <= tmp_3_i_nbreadreq_fu_84_p3;
            end if;
        end if;
    end process;
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, s_axis_tx_data_internal_empty_n, ap_predicate_op18_read_state1, ap_done_reg, tx_shift2ipv4Fifo_full_n, ls_writeRemainder_load_reg_327, ap_predicate_op47_write_state2)
    begin
                ap_block_pp0_stage0_01001 <= ((ap_done_reg = ap_const_logic_1) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (((ls_writeRemainder_load_reg_327 = ap_const_lv1_1) and (tx_shift2ipv4Fifo_full_n = ap_const_logic_0)) or ((ap_predicate_op47_write_state2 = ap_const_boolean_1) and (tx_shift2ipv4Fifo_full_n = ap_const_logic_0)))) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((ap_predicate_op18_read_state1 = ap_const_boolean_1) and (s_axis_tx_data_internal_empty_n = ap_const_logic_0)))));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, s_axis_tx_data_internal_empty_n, ap_predicate_op18_read_state1, ap_done_reg, tx_shift2ipv4Fifo_full_n, ls_writeRemainder_load_reg_327, ap_predicate_op47_write_state2)
    begin
                ap_block_pp0_stage0_11001 <= ((ap_done_reg = ap_const_logic_1) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (((ls_writeRemainder_load_reg_327 = ap_const_lv1_1) and (tx_shift2ipv4Fifo_full_n = ap_const_logic_0)) or ((ap_predicate_op47_write_state2 = ap_const_boolean_1) and (tx_shift2ipv4Fifo_full_n = ap_const_logic_0)))) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((ap_predicate_op18_read_state1 = ap_const_boolean_1) and (s_axis_tx_data_internal_empty_n = ap_const_logic_0)))));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, s_axis_tx_data_internal_empty_n, ap_predicate_op18_read_state1, ap_done_reg, tx_shift2ipv4Fifo_full_n, ls_writeRemainder_load_reg_327, ap_predicate_op47_write_state2)
    begin
                ap_block_pp0_stage0_subdone <= ((ap_done_reg = ap_const_logic_1) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (((ls_writeRemainder_load_reg_327 = ap_const_lv1_1) and (tx_shift2ipv4Fifo_full_n = ap_const_logic_0)) or ((ap_predicate_op47_write_state2 = ap_const_boolean_1) and (tx_shift2ipv4Fifo_full_n = ap_const_logic_0)))) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((ap_predicate_op18_read_state1 = ap_const_boolean_1) and (s_axis_tx_data_internal_empty_n = ap_const_logic_0)))));
    end process;
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(tx_shift2ipv4Fifo_full_n, ls_writeRemainder_load_reg_327, ap_predicate_op47_write_state2)
    begin
                ap_block_state2_pp0_stage0_iter1 <= (((ls_writeRemainder_load_reg_327 = ap_const_lv1_1) and (tx_shift2ipv4Fifo_full_n = ap_const_logic_0)) or ((ap_predicate_op47_write_state2 = ap_const_boolean_1) and (tx_shift2ipv4Fifo_full_n = ap_const_logic_0)));
    end process;
    ...
    ap_condition_131_assign_proc : process(tmp_3_i_nbreadreq_fu_84_p3, ls_writeRemainder, currWord_last_V_fu_172_p3)
    begin
                ap_condition_131 <= ((tmp_3_i_nbreadreq_fu_84_p3 = ap_const_lv1_1) and (ls_writeRemainder = ap_const_lv1_0) and (currWord_last_V_fu_172_p3 = ap_const_lv1_1));
    end process;


    ap_condition_135_assign_proc : process(tmp_3_i_nbreadreq_fu_84_p3, ls_writeRemainder, currWord_last_V_fu_172_p3)
    begin
                ap_condition_135 <= ((tmp_3_i_nbreadreq_fu_84_p3 = ap_const_lv1_1) and (ls_writeRemainder = ap_const_lv1_0) and (currWord_last_V_fu_172_p3 = ap_const_lv1_0));
    end process;
    ...
    ap_predicate_op18_read_state1_assign_proc : process(tmp_3_i_nbreadreq_fu_84_p3, ls_writeRemainder)
    begin
                ap_predicate_op18_read_state1 <= ((tmp_3_i_nbreadreq_fu_84_p3 = ap_const_lv1_1) and (ls_writeRemainder = ap_const_lv1_0));
    end process;


    ap_predicate_op47_write_state2_assign_proc : process(ls_writeRemainder_load_reg_327, tmp_3_i_reg_331)
    begin
                ap_predicate_op47_write_state2 <= ((tmp_3_i_reg_331 = ap_const_lv1_1) and (ls_writeRemainder_load_reg_327 = ap_const_lv1_0));
    end process;
    ...
    or_ln174_3_i_fu_288_p5 <= (((ap_const_lv1_0 & sendWord_last_V_reg_350) & select_ln1269_fu_280_p3) & sendWord_data_V_2_fu_272_p3);
    p_Result_1_fu_251_p3 <= (tmp_5_i7_reg_344 & ap_const_lv20_FFFFF);
    p_Result_2_fu_258_p3 <= (trunc_ln674_reg_338 & reg_136);
    p_Result_3_fu_265_p3 <= (tmp_5_i7_reg_344 & reg_140);
    ...
    sendWord_last_V_fu_204_p2 <= "1" when (tmp_6_i8_fu_194_p4 = ap_const_lv20_0) else "0";
    tmp_3_i_nbreadreq_fu_84_p3 <= (0=>(s_axis_tx_data_internal_empty_n), others=>'-');
    tmp_6_i8_fu_194_p4 <= s_axis_tx_data_internal_dout(575 downto 556);
    trunc_ln674_fu_180_p1 <= s_axis_tx_data_internal_dout(352 - 1 downto 0);

    tx_shift2ipv4Fifo_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, tx_shift2ipv4Fifo_full_n, ls_writeRemainder_load_reg_327, ap_predicate_op47_write_state2, ap_block_pp0_stage0)
    begin
    ...
    tx_shift2ipv4Fifo_din_assign_proc : process(ls_writeRemainder_load_reg_327, ap_predicate_op47_write_state2, zext_ln174_1_fu_299_p1, zext_ln174_fu_322_p1, ap_condition_156)
    begin
        if ((ap_const_boolean_1 = ap_condition_156)) then
            if ((ls_writeRemainder_load_reg_327 = ap_const_lv1_1)) then 
                ...
                tx_shift2ipv4Fifo_din <= zext_ln174_1_fu_299_p1;
            else 
    ...
    tx_shift2ipv4Fifo_write_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ls_writeRemainder_load_reg_327, ap_predicate_op47_write_state2, ap_block_pp0_stage0_11001)
    begin
