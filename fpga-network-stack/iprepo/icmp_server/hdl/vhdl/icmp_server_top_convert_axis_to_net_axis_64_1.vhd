...
attribute shreg_extract : string;
    ...
    signal tmp_61_i_fu_81_p4 : STD_LOGIC_VECTOR (72 downto 0);
...
begin
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, tmp_nbreadreq_fu_36_p6, ap_done_reg, udpIn_internal_full_n, tmp_reg_93, udpIn_TVALID_int_regslice)
    begin
                ap_block_pp0_stage0_01001 <= ((ap_done_reg = ap_const_logic_1) or ((tmp_reg_93 = ap_const_lv1_1) and (udpIn_internal_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((tmp_nbreadreq_fu_36_p6 = ap_const_lv1_1) and (udpIn_TVALID_int_regslice = ap_const_logic_0)))));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, tmp_nbreadreq_fu_36_p6, ap_done_reg, udpIn_internal_full_n, tmp_reg_93, udpIn_TVALID_int_regslice)
    begin
                ap_block_pp0_stage0_11001 <= ((ap_done_reg = ap_const_logic_1) or ((tmp_reg_93 = ap_const_lv1_1) and (udpIn_internal_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((tmp_nbreadreq_fu_36_p6 = ap_const_lv1_1) and (udpIn_TVALID_int_regslice = ap_const_logic_0)))));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, tmp_nbreadreq_fu_36_p6, ap_done_reg, udpIn_internal_full_n, tmp_reg_93, udpIn_TVALID_int_regslice)
    begin
                ap_block_pp0_stage0_subdone <= ((ap_done_reg = ap_const_logic_1) or ((tmp_reg_93 = ap_const_lv1_1) and (udpIn_internal_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((tmp_nbreadreq_fu_36_p6 = ap_const_lv1_1) and (udpIn_TVALID_int_regslice = ap_const_logic_0)))));
    end process;


    ap_block_state1_pp0_stage0_iter0_assign_proc : process(tmp_nbreadreq_fu_36_p6, ap_done_reg, udpIn_TVALID_int_regslice)
    begin
                ap_block_state1_pp0_stage0_iter0 <= ((ap_done_reg = ap_const_logic_1) or ((tmp_nbreadreq_fu_36_p6 = ap_const_lv1_1) and (udpIn_TVALID_int_regslice = ap_const_logic_0)));
    end process;


    ap_block_state2_pp0_stage0_iter1_assign_proc : process(udpIn_internal_full_n, tmp_reg_93)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((tmp_reg_93 = ap_const_lv1_1) and (udpIn_internal_full_n = ap_const_logic_0));
    end process;
    ...
    tmp_61_i_fu_81_p4 <= ((tmp_last_V_reg_107 & tmp_keep_V_reg_102) & tmp_data_V_reg_97);
    tmp_nbreadreq_fu_36_p6 <= (0=>(udpIn_TVALID_int_regslice), others=>'-');

    udpIn_TDATA_blk_n_assign_proc : process(ap_start, ap_CS_fsm_pp0_stage0, tmp_nbreadreq_fu_36_p6, ap_done_reg, ap_block_pp0_stage0, udpIn_TVALID_int_regslice)
    begin
    ...
    udpIn_TREADY_int_regslice_assign_proc : process(ap_start, ap_CS_fsm_pp0_stage0, tmp_nbreadreq_fu_36_p6, ap_block_pp0_stage0_11001)
    begin
    ...
    udpIn_internal_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, udpIn_internal_full_n, tmp_reg_93, ap_block_pp0_stage0)
    begin
    ...
    udpIn_internal_din <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_61_i_fu_81_p4),128));

    udpIn_internal_write_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, tmp_reg_93, ap_block_pp0_stage0_11001)
    begin
